...
La primera parte de este informe corresponde al estudio de un modelo del disco de una galaxia espiral utilizando el perfil de \emph{Miyamoto-Nagai}, dado por el potencial de la forma

\begin{equation}
\phi = \dfrac{GM}{\sqrt{R^2+(a+\sqrt{z^2+b^2})^2}}
\end{equation}\label{eq:MNprof}
